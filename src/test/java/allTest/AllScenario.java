...
public class AllScenario {
        ...
        public void arrageDeparture() throws InterruptedException {
            ...
            List<WebElement> destinationList = driver.findElements(
                    By.xpath("//div[@class='Popup AutocompleteSearch__Popup']//li")
            );
...
//        }
            ...
            WebElement airportDestination = destinationList.stream().filter( dest->
                    dest.getText().contains("Singapore Changi Airport")).findFirst().orElse(null);
            System.out.println("Airport"+airportDestination.getText());
            airportDestination.click();

//
            Thread.sleep(1000);

            // Format tanggal seperti yang digunakan di atribut data-selenium-date
            DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");

            // Misalnya ambil tanggal besok
            ...
            // Buat XPath dinamis
            String xpath = String.format("//span[@data-selenium-date='%s']", tanggalString);
...
//       }
            ...
            wait.until(ExpectedConditions.visibilityOfElementLocated(airlinesSection));
